...
> = {
  ERMS: {
    ...
    danger: "수준이 맞지 않는 수업 환경에서는 흥미를 잃기 쉽습니다. 또래와 결이 안 맞으면 학습 의욕이 떨어질 수 있습니다.",
...
function makeScores(answers: number[]) {
  ...
  answers.forEach((answer, idx) => {
    ...
    Object.entries(map).forEach(([key, value]) => {
      total[key] += scoreAnswer(value, answer);
    });
  });
...
function generatePrintableReport({
  ...
  report: (typeof RESULT_DB)[string];
